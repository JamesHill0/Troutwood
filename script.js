...
var questions = [
    {prompt:"1) What is the S&P 500?", answer:0, choices:["500+ of the largest publicly traded companies in the U.S.", "Supersonic stealth drone fighter", "NASCAR race", "A newly discovered comet circling Neptune"]},
    ...
    {prompt:"7) What is an interest rate (*challenge question)?", answer:5, choices:["a. The amount of money a bank or entity pays savers or lenders.", "b. The rate a bank or entity charges borrowers.", "c.  A joint investment in agriculture enhancement between Greenland and the United States", "d. Both a and b"]},
